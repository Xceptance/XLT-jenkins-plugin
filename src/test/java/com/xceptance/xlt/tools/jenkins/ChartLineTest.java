...
public class ChartLineTest
{
    public static class TestData
    {
        ...
        {
            ChartLine<String, String> line = newDefaultInitializedChartLine();
    ...
    public final void AddLineValue_DefaultInitializedChartLineWithoutValueEntries_ValueCountIsTwo()
    {
        ...
        assertSame("Values not added as expected. The value cound should be 2.", expectedValueCount, currentValueCount);
    }
