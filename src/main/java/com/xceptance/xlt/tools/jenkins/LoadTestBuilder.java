                ...
                for (int i = builds.size() - 1; i > -1; i--)
                {
                    ...
                    if (testDataFile.exists())
                    {
                        ...
                        for (String eachCriteriaID : getCriteriaConfigIDs(eachPlotID))
                        {
                            ...
                            if (number.isNaN())
                                throw new NumberFormatException("Value is not a number. (criteria id: \"" + eachCriteriaID +
                                                                "\" XPath: \"" + xPath + "\"");
                            else
                            {
                    ...
                    try
                    {
                        ...
                        for (String eachID : criteriaIDs)
                        {
                            ...
                            try
                            {
                                ...
                                Element node = (Element) XPathFactory.newInstance().newXPath()
                                                                     .evaluate(xPath, dataXml, XPathConstants.NODE);
                                if (node == null)
                                {
                                ...
                                if (!number.isNaN())
                                {
                                    ...
                                    if (chart != null)
                                    {
                                        listener.getLogger().println("Add plot value. Criteria \"" + eachID + "\"\t Value: \"" + number +
                                                                         "\"\t Path: \"" + xPath);
                                ...
                                {
                                    listener.getLogger().println("Plot value is not a number. Criteria \"" + eachID + "\"\t Value: \"" +
                                                                     number + "\"\t Path: \"" + xPath);
                                }
                                ...
                                if (!condition.isEmpty())
                                {
                                    ...
                                    Node result = (Node) XPathFactory.newInstance().newXPath()
                                                                     .evaluate(conditionPath, dataXml, XPathConstants.NODE);
                                    if (result == null)
                                    {
